        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="feature-1">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas ullam, cumque a debitis
                        reiciendis dolorum ad minus error.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="feature-1">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente reprehenderit aspernatur,
                    reiciendis explicabo doloribus aperiam sed sequi, aut repudiandae magni nobis voluptatem!</p>
...
<div class="site-section section-3" data-stellar-background-ratio="0.5"
    style="background-image: url('assets/front/images/hero_2.jpg');">
    <div class="container">
        <div class="row justify-content-center text-center">
    ...
    <div class="container">
        <div class="row justify-content-center  mb-5">
            <div class="col-md-7 text-center">
                ...
                <p class="mb-5 lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure nesciunt nemo vel
    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-7 text-center mb-5">
                ...
                <p class="lead text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam quo
    ...
    <div class="container">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-7 text-center mb-5">
                ...
                <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo assumenda, dolorum
        ...
        <div class="row">
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="testimonial-2 text-center">
                    <div class="v-card mb-4 text-center">
                        <img src="{{url('assets/front/images/person_1.jpg')}}" alt="Image"
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="testimonial-2 text-center">
                    <div class="v-card mb-4 text-center">
                        <img src="{{url('assets/front/images/person_2.jpg')}}" alt="Image"
                            class="img-fluid mx-auto d-block'">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="testimonial-2 text-center">
                    <div class="v-card mb-4 text-center">
                        <img src="{{url('assets/front/images/person_3.jpg')}}" alt="Image"
                            class="img-fluid mx-auto d-block">
...
<div class="site-section section-3" data-stellar-background-ratio="0.5"
    style="background-image: url('{{url('assets/front/assets/front/images/hero_1.jpg')}}');">
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-7 text-center mb-5">
