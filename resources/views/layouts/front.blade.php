...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('assets/front/images/hero_1.jpg')">
        <div class="container">
          <div class="row align-items-center ">
            ...
            <div class="col-md-6 ml-auto">
              <div class="white-dots">
                <img src="{{url('assets/front/images/img_2.jpg')}}" alt="" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-5">
            ...
            <div class="d-flex align-items-center">
              <span class="sign mr-4">
                <img src="{{url('assets/front/images/signature.svg')}}" alt="" class="img-fluid">
              </span>
              <div>
    ...
    <div class="site-section section-3" data-stellar-background-ratio="0.5" style="background-image: url('assets/front/images/hero_2.jpg');">
      <div class="container">
        <div class="row justify-content-center text-center">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="nonloop-block-13 owl-carousel">
              <div class="news-1" style="background-image: url('assets/front/images/img_1.jpg');">
                <div class="text">
              ...
              <div class="news-1" style="background-image: url('assets/front/images/img_2.jpg');">
                <div class="text">
                  <h3><a href="#">Consectetur adipisicing elit</a></h3>
                  <span class="category d-block mb-3">Web Development</span>
                  <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
              ...
              <div class="news-1" style="background-image: url('assets/front/images/img_3.jpg');">
                <div class="text">
                  <h3><a href="#">Consectetur adipisicing elit</a></h3>
                  <span class="category d-block mb-3">Web Development</span>
                  <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2 text-center">
              <div class="v-card mb-4 text-center">
                <img src="{{url('assets/front/images/person_1.jpg')}}" alt="Image" class="img-fluid mx-auto d-block">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2 text-center">
              <div class="v-card mb-4 text-center">
                <img src="{{url('assets/front/images/person_2.jpg')}}" alt="Image" class="img-fluid mx-auto d-block'">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2 text-center">
              <div class="v-card mb-4 text-center">
                <img src="{{url('assets/front/images/person_3.jpg')}}" alt="Image" class="img-fluid mx-auto d-block">
    ...
    <div class="site-section section-3" data-stellar-background-ratio="0.5" style="background-image: url('{{url('assets/front/assets/front/images/hero_1.jpg')}}');">
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-7 text-center mb-5">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="{{url('assets/front/images/img_1.jpg')}}" alt="Image"
                 class="img-fluid">
              </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="{{url('assets/front/images/img_2.jpg')}}" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="{{url('assets/front/images/img_3.jpg')}}" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
